package ikigaiworks.letseat.ui.view.animation;
...
@EViewGroup(R.layout.view_like_button)
public class LikeButtonView extends FrameLayout implements View.OnClickListener {
    ...
    @ViewById(R.id.ivStar)
    protected ImageView ivStar;
    @ViewById(R.id.vDotsView)
    protected DotsView vDotsView;
    @ViewById(R.id.vCircle)
    protected CircleView vCircle;
